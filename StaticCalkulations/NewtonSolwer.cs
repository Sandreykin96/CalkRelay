...
{
    public abstract class NewtonSolwer
    {
        ...
        public Vector<double> Pg { get; private set; }

        public int NodeCount { get; private set; }

        public int PQVNodeCount { get; private set; }

        public int PVNodeCount { get; private set; }

        public int PQNodeCount { get; private set; }

        public abstract Vector<Complex> NodeResult { get; }

        public Vector<double> Qg { get; private set; }
        public Vector<double> U { get; private set; }

        public Matrix<Complex> Y { get; private set; }

        public Matrix<double> G { get; private set; }

        public Matrix<double> B { get; private set; }

        public Complex RelaxNode { get; private set; }

        public double Error { get; set; } = 1e-4;
    ...
    public class RectangularSolver : NewtonSolwer
    {
    ...
    public class PolarSolver : NewtonSolwer
    {
